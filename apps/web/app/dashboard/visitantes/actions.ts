...
const visitorSchema = z.object({
    ...
    subcontratada_empresa_id: z.string().optional().nullable(),
...
export async function createOrUpdateVisitor(prevState: any, formData: FormData) {
    ...
    const rawData = {
        ...
        subcontratada_empresa_id: formData.get('subcontratada_empresa_id') as string === 'none' || !formData.get('subcontratada_empresa_id') ? null : formData.get('subcontratada_empresa_id') as string,
